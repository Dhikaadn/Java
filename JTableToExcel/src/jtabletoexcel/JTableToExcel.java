...
class JTableToExcel extends JFrame{
    String header[] = {"Firstname","Lastname","Email","Tanggal"};
	String data[][];
	...
	JLabel lbl_tgl = new JLabel(" Tanggal");
	...
	JTextField txt_tgl = new JTextField(20);
	...
	public JTableToExcel(){
		...
		pane_input.add(lbl_tgl);
		pane_input.add(txt_tgl);
    ...
    class AksyonListener implements ActionListener{
	    public void actionPerformed(ActionEvent e){
			if(e.getSource() == btn_add || e.getSource() == txt_email){
				...
				model.insertRow(model.getRowCount(), new Object[]{fn, ln, mail, tg});
